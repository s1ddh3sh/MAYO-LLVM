...
for.body.i.iter2:                                 ; preds = %iter_2_start
  ...
  %7 = load i64, ptr %arrayidx.i.iter2, align 8, !dbg !176
  %and.i.iter2 = and i64 %7, 1229782938247303441, !dbg !179
  ...
  %shr.i.iter2 = lshr i64 %7, 1, !dbg !183
  ...
  %8 = load i64, ptr %arrayidx8.i.iter2, align 8, !dbg !190
  %shr9.i.iter2 = lshr i64 %8, 2, !dbg !191
  ...
  %9 = load i64, ptr %arrayidx16.i.iter2, align 8, !dbg !198
  %shr17.i.iter2 = lshr i64 %9, 3, !dbg !199
  ...
  %10 = load i64, ptr %arrayidx24.i.iter2, align 8, !dbg !207
  %xor25.i.iter2 = xor i64 %10, %xor23.i.iter2, !dbg !207
...
for.body.i.iter3:                                 ; preds = %iter_3_start
  ...
  %11 = load i64, ptr %arrayidx.i.iter3, align 8, !dbg !176
  %and.i.iter3 = and i64 %11, 1229782938247303441, !dbg !179
  ...
  %shr.i.iter3 = lshr i64 %11, 1, !dbg !183
  ...
  %12 = load i64, ptr %arrayidx8.i.iter3, align 8, !dbg !190
  %shr9.i.iter3 = lshr i64 %12, 2, !dbg !191
  ...
  %13 = load i64, ptr %arrayidx16.i.iter3, align 8, !dbg !198
  %shr17.i.iter3 = lshr i64 %13, 3, !dbg !199
  ...
  %14 = load i64, ptr %arrayidx24.i.iter3, align 8, !dbg !207
  %xor25.i.iter3 = xor i64 %14, %xor23.i.iter3, !dbg !207
...
for.body.i.iter4:                                 ; preds = %iter_4_start
  ...
  %15 = load i64, ptr %arrayidx.i.iter4, align 8, !dbg !176
  %and.i.iter4 = and i64 %15, 1229782938247303441, !dbg !179
  ...
  %shr.i.iter4 = lshr i64 %15, 1, !dbg !183
  ...
  %16 = load i64, ptr %arrayidx8.i.iter4, align 8, !dbg !190
  %shr9.i.iter4 = lshr i64 %16, 2, !dbg !191
  ...
  %17 = load i64, ptr %arrayidx16.i.iter4, align 8, !dbg !198
  %shr17.i.iter4 = lshr i64 %17, 3, !dbg !199
  ...
  %18 = load i64, ptr %arrayidx24.i.iter4, align 8, !dbg !207
  %xor25.i.iter4 = xor i64 %18, %xor23.i.iter4, !dbg !207
