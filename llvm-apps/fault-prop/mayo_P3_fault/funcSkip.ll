...
for.cond1.preheader.i1:                           ; preds = %for.cond1.for.inc17_crit_edge.i, %entry
  ...
  %bs_mat_entries_used.06.i = phi i32 [ 0, %entry ], [ %add14.i11.lcssa, %for.cond1.for.inc17_crit_edge.i ]
...
for.cond1.for.inc17_crit_edge.i:                  ; preds = %for.inc15.i10
  %add14.i11.lcssa = phi i32 [ %add14.i11, %for.inc15.i10 ], !dbg !257
  ...
  %indvars.iv.next.i = add nsw i32 %indvars.iv5.i, -1, !dbg !263
    #dbg_value(i32 %add14.i11.lcssa, !159, !DIExpression(), !150)
  %exitcond2.not.i16 = icmp eq i32 %inc18.i15, 78, !dbg !264
  br i1 %exitcond2.not.i16, label %for.cond1.preheader.i.preheader, label %for.cond1.preheader.i1, !dbg !163, !llvm.loop !265

for.cond1.preheader.i.preheader:                  ; preds = %for.cond1.for.inc17_crit_edge.i
  br label %for.cond1.preheader.i, !dbg !267

for.cond1.preheader.i:                            ; preds = %for.cond1.preheader.i.preheader, %for.inc17.i
  %r.03.i = phi i32 [ %inc18.i, %for.inc17.i ], [ 0, %for.cond1.preheader.i.preheader ]
    #dbg_value(i32 %r.03.i, !273, !DIExpression(), !274)
    #dbg_value(i32 0, !275, !DIExpression(), !279)
  br label %for.cond4.preheader.i, !dbg !280

for.cond4.preheader.i:                            ; preds = %for.inc15.i, %for.cond1.preheader.i
  %c.02.i = phi i32 [ 0, %for.cond1.preheader.i ], [ %inc.i, %for.inc15.i ]
    #dbg_value(i32 %c.02.i, !275, !DIExpression(), !279)
    #dbg_value(i32 0, !281, !DIExpression(), !285)
  br label %for.body6.i, !dbg !286
...
for.body6.i:                                      ; preds = %m_vec_mul_add.exit61, %for.cond4.preheader.i
  %k.01.i = phi i32 [ 0, %for.cond4.preheader.i ], [ %add14.i, %m_vec_mul_add.exit61 ]
    #dbg_value(i32 %k.01.i, !281, !DIExpression(), !285)
  %mul.i = shl nuw nsw i32 %c.02.i, 3, !dbg !287
  %add.i = or disjoint i32 %mul.i, %k.01.i, !dbg !290
  %add.ptr.idx.i = mul nuw nsw i32 %add.i, 40, !dbg !291
  %add.ptr.i = getelementptr inbounds nuw i8, ptr %P2, i32 %add.ptr.idx.i, !dbg !291
  %mul8.i = shl nuw nsw i32 %c.02.i, 3, !dbg !292
  %8 = getelementptr i8, ptr %O, i32 %mul8.i, !dbg !293
  %arrayidx.i = getelementptr i8, ptr %8, i32 %r.03.i, !dbg !293
  %9 = load i8, ptr %arrayidx.i, align 1, !dbg !293
  %mul10.i = shl nuw nsw i32 %r.03.i, 3, !dbg !294
  %add11.i = or disjoint i32 %mul10.i, %k.01.i, !dbg !295
  %add.ptr13.idx.i = mul nuw nsw i32 %add11.i, 40, !dbg !296
  %add.ptr13.i = getelementptr inbounds nuw i8, ptr %P3, i32 %add.ptr13.idx.i, !dbg !296
    #dbg_value(i32 5, !184, !DIExpression(), !297)
    #dbg_value(ptr %add.ptr.i, !191, !DIExpression(), !297)
    #dbg_value(i8 %9, !192, !DIExpression(), !297)
    #dbg_value(ptr %add.ptr13.i, !193, !DIExpression(), !297)
    #dbg_value(i8 %9, !194, !DIExpression(), !299)
  %conv.i.i21 = zext i8 %9 to i32, !dbg !301
  %mul.i.i22 = mul i32 %conv.i.i21, 134480385, !dbg !302
    #dbg_value(i32 %mul.i.i22, !203, !DIExpression(), !299)
    #dbg_value(i32 -252645136, !204, !DIExpression(), !299)
  %and.i.i23 = and i32 %mul.i.i22, -252645136, !dbg !303
    #dbg_value(i32 %and.i.i23, !206, !DIExpression(), !299)
  %shr.i.i24 = lshr exact i32 %and.i.i23, 4, !dbg !304
  %shr1.i.i25 = lshr exact i32 %and.i.i23, 3, !dbg !305
  %10 = xor i32 %shr.i.i24, %shr1.i.i25, !dbg !306
  %xor2.i.i26 = xor i32 %10, %mul.i.i22, !dbg !306
    #dbg_value(i32 %xor2.i.i26, !210, !DIExpression(), !297)
    #dbg_value(i64 1229782938247303441, !211, !DIExpression(), !297)
    #dbg_value(i32 0, !212, !DIExpression(), !307)
  br label %for.body.i27, !dbg !308

for.body.i27:                                     ; preds = %for.body.i27, %for.body6.i
  %i.01.i28 = phi i32 [ 0, %for.body6.i ], [ %inc.i59, %for.body.i27 ]
    #dbg_value(i32 %i.01.i28, !212, !DIExpression(), !307)
  %arrayidx.i29 = getelementptr inbounds nuw i64, ptr %add.ptr.i, i32 %i.01.i28, !dbg !309
  %11 = load i64, ptr %arrayidx.i29, align 8, !dbg !309
  %and.i30 = and i64 %11, 1229782938247303441, !dbg !310
  %and1.i31 = and i32 %xor2.i.i26, 255, !dbg !311
  %conv.i32 = zext nneg i32 %and1.i31 to i64, !dbg !312
  %mul.i33 = mul i64 %and.i30, %conv.i32, !dbg !313
  %shr.i34 = lshr i64 %11, 1, !dbg !314
  %and3.i35 = and i64 %shr.i34, 1229782938247303441, !dbg !315
  %shr4.i36 = lshr i32 %xor2.i.i26, 8, !dbg !316
  %and5.i37 = and i32 %shr4.i36, 15, !dbg !317
  %conv6.i38 = zext nneg i32 %and5.i37 to i64, !dbg !318
  %mul7.i39 = mul nuw i64 %and3.i35, %conv6.i38, !dbg !319
  %xor.i40 = xor i64 %mul.i33, %mul7.i39, !dbg !320
  %arrayidx8.i41 = getelementptr inbounds nuw i64, ptr %add.ptr.i, i32 %i.01.i28, !dbg !321
  %12 = load i64, ptr %arrayidx8.i41, align 8, !dbg !321
  %shr9.i42 = lshr i64 %12, 2, !dbg !322
  %and10.i43 = and i64 %shr9.i42, 1229782938247303441, !dbg !323
  %shr11.i44 = lshr i32 %xor2.i.i26, 16, !dbg !324
  %and12.i45 = and i32 %shr11.i44, 15, !dbg !325
  %conv13.i46 = zext nneg i32 %and12.i45 to i64, !dbg !326
  %mul14.i47 = mul nuw i64 %and10.i43, %conv13.i46, !dbg !327
  %xor15.i48 = xor i64 %xor.i40, %mul14.i47, !dbg !328
  %arrayidx16.i49 = getelementptr inbounds nuw i64, ptr %add.ptr.i, i32 %i.01.i28, !dbg !329
  %13 = load i64, ptr %arrayidx16.i49, align 8, !dbg !329
  %shr17.i50 = lshr i64 %13, 3, !dbg !330
  %and18.i51 = and i64 %shr17.i50, 1229782938247303441, !dbg !331
  %shr19.i52 = lshr i32 %xor2.i.i26, 24, !dbg !332
  %and20.i53 = and i32 %shr19.i52, 15, !dbg !333
  %conv21.i54 = zext nneg i32 %and20.i53 to i64, !dbg !334
  %mul22.i55 = mul nuw i64 %and18.i51, %conv21.i54, !dbg !335
  %xor23.i56 = xor i64 %xor15.i48, %mul22.i55, !dbg !336
  %arrayidx24.i57 = getelementptr inbounds nuw i64, ptr %add.ptr13.i, i32 %i.01.i28, !dbg !337
  %14 = load i64, ptr %arrayidx24.i57, align 8, !dbg !338
  %xor25.i58 = xor i64 %14, %xor23.i56, !dbg !338
  store i64 %xor25.i58, ptr %arrayidx24.i57, align 8, !dbg !338
  %inc.i59 = add nuw nsw i32 %i.01.i28, 1, !dbg !339
    #dbg_value(i32 %inc.i59, !212, !DIExpression(), !307)
  %exitcond.not.i60 = icmp eq i32 %inc.i59, 5, !dbg !340
  br i1 %exitcond.not.i60, label %m_vec_mul_add.exit61, label %for.body.i27, !dbg !308, !llvm.loop !341

m_vec_mul_add.exit61:                             ; preds = %for.body.i27
  %add14.i = add nuw nsw i32 %k.01.i, 1, !dbg !343
    #dbg_value(i32 %add14.i, !281, !DIExpression(), !285)
  %exitcond.not.i = icmp eq i32 %add14.i, 8, !dbg !344
  br i1 %exitcond.not.i, label %for.inc15.i, label %for.body6.i, !dbg !286, !llvm.loop !345

for.inc15.i:                                      ; preds = %m_vec_mul_add.exit61
  %inc.i = add nuw nsw i32 %c.02.i, 1, !dbg !347
    #dbg_value(i32 %inc.i, !275, !DIExpression(), !279)
  %exitcond1.not.i = icmp eq i32 %inc.i, 78, !dbg !348
  br i1 %exitcond1.not.i, label %for.inc17.i, label %for.cond4.preheader.i, !dbg !280, !llvm.loop !349

for.inc17.i:                                      ; preds = %for.inc15.i
  %inc18.i = add nuw nsw i32 %r.03.i, 1, !dbg !351
    #dbg_value(i32 %inc18.i, !273, !DIExpression(), !274)
  %exitcond2.not.i = icmp eq i32 %inc18.i, 8, !dbg !352
  br i1 %exitcond2.not.i, label %mul_add_mat_trans_x_m_mat.exit, label %for.cond1.preheader.i, !dbg !267, !llvm.loop !353
...
!267 = !DILocation(line: 50, column: 5, scope: !268, inlinedAt: !272)
!268 = distinct !DILexicalBlock(scope: !269, file: !92, line: 50, column: 5)
!269 = distinct !DISubprogram(name: "mul_add_mat_trans_x_m_mat", scope: !92, file: !92, line: 47, type: !270, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !37, retainedNodes: !58)
!270 = !DISubroutineType(types: !271)
!271 = !{null, !134, !19, !126, !39, !134, !134, !134}
!272 = distinct !DILocation(line: 270, column: 5, scope: !91)
!273 = !DILocalVariable(name: "r", scope: !268, file: !92, line: 50, type: !10)
!274 = !DILocation(line: 0, scope: !268, inlinedAt: !272)
!275 = !DILocalVariable(name: "c", scope: !276, file: !92, line: 51, type: !10)
!276 = distinct !DILexicalBlock(scope: !277, file: !92, line: 51, column: 9)
!277 = distinct !DILexicalBlock(scope: !278, file: !92, line: 50, column: 40)
!278 = distinct !DILexicalBlock(scope: !268, file: !92, line: 50, column: 5)
!279 = !DILocation(line: 0, scope: !276, inlinedAt: !272)
!280 = !DILocation(line: 51, column: 9, scope: !276, inlinedAt: !272)
!281 = !DILocalVariable(name: "k", scope: !282, file: !92, line: 52, type: !10)
!282 = distinct !DILexicalBlock(scope: !283, file: !92, line: 52, column: 13)
!283 = distinct !DILexicalBlock(scope: !284, file: !92, line: 51, column: 44)
!284 = distinct !DILexicalBlock(scope: !276, file: !92, line: 51, column: 9)
!285 = !DILocation(line: 0, scope: !282, inlinedAt: !272)
!286 = !DILocation(line: 52, column: 13, scope: !282, inlinedAt: !272)
!287 = !DILocation(line: 53, column: 70, scope: !288, inlinedAt: !272)
!288 = distinct !DILexicalBlock(scope: !289, file: !92, line: 52, column: 54)
!289 = distinct !DILexicalBlock(scope: !282, file: !92, line: 52, column: 13)
!290 = !DILocation(line: 53, column: 84, scope: !288, inlinedAt: !272)
!291 = !DILocation(line: 53, column: 51, scope: !288, inlinedAt: !272)
!292 = !DILocation(line: 53, column: 96, scope: !288, inlinedAt: !272)
!293 = !DILocation(line: 53, column: 90, scope: !288, inlinedAt: !272)
!294 = !DILocation(line: 53, column: 136, scope: !288, inlinedAt: !272)
!295 = !DILocation(line: 53, column: 150, scope: !288, inlinedAt: !272)
!296 = !DILocation(line: 53, column: 117, scope: !288, inlinedAt: !272)
!297 = !DILocation(line: 0, scope: !185, inlinedAt: !298)
!298 = distinct !DILocation(line: 53, column: 17, scope: !288, inlinedAt: !272)
!299 = !DILocation(line: 0, scope: !195, inlinedAt: !300)
!300 = distinct !DILocation(line: 33, column: 20, scope: !185, inlinedAt: !298)
!301 = !DILocation(line: 130, column: 19, scope: !195, inlinedAt: !300)
!302 = !DILocation(line: 130, column: 33, scope: !195, inlinedAt: !300)
!303 = !DILocation(line: 134, column: 28, scope: !195, inlinedAt: !300)
!304 = !DILocation(line: 135, column: 28, scope: !195, inlinedAt: !300)
!305 = !DILocation(line: 135, column: 47, scope: !195, inlinedAt: !300)
!306 = !DILocation(line: 135, column: 34, scope: !195, inlinedAt: !300)
!307 = !DILocation(line: 0, scope: !213, inlinedAt: !298)
!308 = !DILocation(line: 37, column: 5, scope: !213, inlinedAt: !298)
!309 = !DILocation(line: 38, column: 21, scope: !217, inlinedAt: !298)
!310 = !DILocation(line: 38, column: 33, scope: !217, inlinedAt: !298)
!311 = !DILocation(line: 38, column: 51, scope: !217, inlinedAt: !298)
!312 = !DILocation(line: 38, column: 46, scope: !217, inlinedAt: !298)
!313 = !DILocation(line: 38, column: 44, scope: !217, inlinedAt: !298)
!314 = !DILocation(line: 39, column: 27, scope: !217, inlinedAt: !298)
!315 = !DILocation(line: 39, column: 33, scope: !217, inlinedAt: !298)
!316 = !DILocation(line: 39, column: 52, scope: !217, inlinedAt: !298)
!317 = !DILocation(line: 39, column: 59, scope: !217, inlinedAt: !298)
!318 = !DILocation(line: 39, column: 46, scope: !217, inlinedAt: !298)
!319 = !DILocation(line: 39, column: 44, scope: !217, inlinedAt: !298)
!320 = !DILocation(line: 39, column: 17, scope: !217, inlinedAt: !298)
!321 = !DILocation(line: 40, column: 21, scope: !217, inlinedAt: !298)
!322 = !DILocation(line: 40, column: 27, scope: !217, inlinedAt: !298)
!323 = !DILocation(line: 40, column: 33, scope: !217, inlinedAt: !298)
!324 = !DILocation(line: 40, column: 52, scope: !217, inlinedAt: !298)
!325 = !DILocation(line: 40, column: 59, scope: !217, inlinedAt: !298)
!326 = !DILocation(line: 40, column: 46, scope: !217, inlinedAt: !298)
!327 = !DILocation(line: 40, column: 44, scope: !217, inlinedAt: !298)
!328 = !DILocation(line: 40, column: 17, scope: !217, inlinedAt: !298)
!329 = !DILocation(line: 41, column: 21, scope: !217, inlinedAt: !298)
!330 = !DILocation(line: 41, column: 27, scope: !217, inlinedAt: !298)
!331 = !DILocation(line: 41, column: 33, scope: !217, inlinedAt: !298)
!332 = !DILocation(line: 41, column: 52, scope: !217, inlinedAt: !298)
!333 = !DILocation(line: 41, column: 59, scope: !217, inlinedAt: !298)
!334 = !DILocation(line: 41, column: 46, scope: !217, inlinedAt: !298)
!335 = !DILocation(line: 41, column: 44, scope: !217, inlinedAt: !298)
!336 = !DILocation(line: 41, column: 17, scope: !217, inlinedAt: !298)
!337 = !DILocation(line: 38, column: 9, scope: !217, inlinedAt: !298)
!338 = !DILocation(line: 38, column: 16, scope: !217, inlinedAt: !298)
!339 = !DILocation(line: 37, column: 40, scope: !218, inlinedAt: !298)
!340 = !DILocation(line: 37, column: 20, scope: !218, inlinedAt: !298)
!341 = distinct !{!341, !308, !342, !252}
!342 = !DILocation(line: 42, column: 5, scope: !213, inlinedAt: !298)
!343 = !DILocation(line: 52, column: 48, scope: !289, inlinedAt: !272)
!344 = !DILocation(line: 52, column: 31, scope: !289, inlinedAt: !272)
!345 = distinct !{!345, !286, !346, !252}
!346 = !DILocation(line: 54, column: 13, scope: !282, inlinedAt: !272)
!347 = !DILocation(line: 51, column: 40, scope: !284, inlinedAt: !272)
!348 = !DILocation(line: 51, column: 27, scope: !284, inlinedAt: !272)
!349 = distinct !{!349, !280, !350, !252}
!350 = !DILocation(line: 55, column: 9, scope: !276, inlinedAt: !272)
!351 = !DILocation(line: 50, column: 36, scope: !278, inlinedAt: !272)
!352 = !DILocation(line: 50, column: 23, scope: !278, inlinedAt: !272)
!353 = distinct !{!353, !267, !354, !252}
!354 = !DILocation(line: 56, column: 5, scope: !268, inlinedAt: !272)
!355 = !DILocation(line: 271, column: 1, scope: !91)
